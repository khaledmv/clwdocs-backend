                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('login') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="email" name="email" id="email" required="" :value="old('email')" placeholder="Enter your email">
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Your Partner for Water Quality, Wastewater Treatment, & Odor Control.</h3>
