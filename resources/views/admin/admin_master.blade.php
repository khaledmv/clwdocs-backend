...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | CLW DOCUMENTS </title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col fs-13 text-muted text-center">
                                &copy; <script>document.write(new Date().getFullYear())</script> - <span class="mdi mdi-heart text-danger"></span> by <a href="#" class="text-reset fw-semibold"> Khaled Hossain</a> 
                            </div>
                        </div>
                    </div>
                </footer>
