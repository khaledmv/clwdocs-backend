                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-header d-flex flex-wrap gap-4 align-items-center">
                                        <h5 class="card-title mb-0">Product Category Taxonomy</h5>
                                        <h5 class="card-title mb-0"><a href="{{ route('taxonomy.create', 'product-categories') }}" class="btn btn-outline-primary rounded-pill">Add New</a></h5>
